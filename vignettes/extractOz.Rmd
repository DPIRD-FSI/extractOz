...
Using the previously created list of GPS points, fetch weather data from SILO for 2020.
This is a non-working example, replace `YOUR_EMAIL_ADDRESS` with your email address below.
